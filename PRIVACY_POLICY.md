...
## Introduction
This Privacy Policy describes how the RAF Tracking application ("we", "our", or "the App") collects, uses, and protects your information. The App is designed for tracking Houbara locations, scanning QR codes, and uploading related data.
...
* To ensure data integrity when uploading tracking data.
