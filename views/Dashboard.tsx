            ...
            {transmitterStatusData.map((st) => (
              ...
              >
                <div className="flex items-center gap-1.5 sm:gap-2.5 min-w-0 truncate">
                  ...
                  <span className="text-xs sm:text-lg font-semibold text-slate-700 dark:text-slate-300 truncate">{st.name}:</span>
                </div>
                <span className="text-xs sm:text-lg font-black px-1.5 sm:px-2.5 py-0.5 sm:py-1 rounded-md bg-slate-100 dark:bg-slate-700 text-slate-900 dark:text-white flex-shrink-0">
                  {st.value}
                </span>
              </div>
            ))}
